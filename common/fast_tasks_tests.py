...
assert(tuple(arithmetic_mean([1.0, -3.0, 5.0])) == 1.0)
assert(tuple(arithmetic_mean([23.0, 5.0, 14.0])) == 14.0)
assert(tuple(arithmetic_mean([1.6 , 4.0 , 6.8 , 5.7])) == 4.525)
assert(tuple(arithmetic_median([1.0, 3.0, -5.0])) == 1.0)
assert(tuple(arithmetic_median([23.0, 5.0, 14.0 , 4.0 , 6.8])) == 6.8)
assert(tuple(arithmetic_median([-1.6 , 4.0 , 6.8 , 5.7])) == 4.85)
assert(tuple(int(positive_ammount([-1.0, -3.0, 5.0]))) == 1)
assert(tuple(int(positive_ammount([23.0, -5.0, 14.0, -14.0]))) == 2)
assert(tuple(int(positive_ammount([1.6 , -4.0 , 6.8 , -5.7, -4.655, 6.894]))) == 3)
assert(tuple(float(positive_percent([-1.0, 5.0]))) == 50.0)
assert(tuple(float(positive_percent([23.0, -5.0, -14.0, -14.0]))) == 25.0)
assert(tuple(float(positive_percent([1.6 , 4.0 -5.7, 4.655, 6.894]))) == 80.0)
